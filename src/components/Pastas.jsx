            ...
            {currentItems.map((item, index) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-6">
                  ...
                  {/* Versión 2x */}
                  <div 
                    className="relative bg-red-600 shadow-black  rounded-sm overflow-hidden shadow-lg cursor-pointer transition-all h-[250px] hover:shadow-xl sm:h-[400px] w-full max-w-[300px] mx-auto hover:"
