...
const MazorcaSalchipapa = ({ onReturn, onNavigate }) => {
  ...
  const items = [
    {
      ...
      items: [
        { 
          ...
          price: "$18.000", 
          desc: "Mazorca desgranada con mantequilla y queso",
          img: "/img/mazorca-desgranada.jpg"
        },
        { 
          name: "Salchipapa Especial", 
          price: "$22.000", 
          desc: "Papas fritas con salchichas, salsas y toppings",
          img: "/img/salchipapa-especial.jpg"
        },
      ]
    }
  ];
