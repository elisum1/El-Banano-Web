...
const PicadaMixtos = (onReturn) => {
  ...
  const items = [
    {
      id: 'picada',
      title: "PICADA Y MIXTOS",
      subtitle: "Para compartir en buena compañía",
      description: "Selección de carnes y embutidos para picar",
      items: [
        { 
          name: "Picada de la Casa", 
          price1: "$45.000", 
          price2: "$65.000",
          desc1: "Variedad de carnes, chorizos, chicharrón y arepas",
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row relative bg-gray-50">
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-br from-blue-400 to-blue-300 p-3 md:p-8 flex flex-col justify-center relative">
        <button 
        ...
        <motion.div 
          ...
          transition={{ delay: 0.3, duration: 0.6 }}
        >
          <div className="bg-blue-400 p-3 md:p-6 text-center">
            ...
            {currentItems.map((item, index) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-6">
                  {/* Versión 1x */}
                  <div 
                    className="relative shadow-black bg-gray-300 rounded-sm overflow-hidden shadow-lg cursor-pointer transition-all h-[250px] hover:shadow-xl sm:h-[400px] w-full max-w-[300px] mx-auto hover:"
          ...
          <div className="bg-blue-100 p-2 md:p-4 text-center border-t-2 border-blue-200">
            <p className="text-blue-900 font-bold italic text-xs md:text-sm lg:text-base">¡Todas nuestras picadas incluyen salsas y acompañamientos!</p>
          </div>
        </motion.div>
