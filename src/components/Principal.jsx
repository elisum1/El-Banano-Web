...
<div className="w-[70%] lg:w-[50%] sm:h-[60%] h-[50%]  2xl:h-[58.5%] lg:h-[56.5%] sm:flex flex-col items-center justify-center m-auto  hidden relative top-[10%]">
              
                <p className="w-[100%] text-3xl sm:text-4xl 2xl:text-7xl font-extrabold font-gotham azul-text sm:text-center  "> EL ORIGINAL DESDE 1986</p>
            </div>
