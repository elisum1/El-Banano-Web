    ...
    <footer className="bg-blue-950 text-white py-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            <li><a href="/menu" className="hover:text-yellow-400 transition-colors">Menú</a></li>
            <li><a href="/especialidades" className="hover:text-yellow-400 transition-colors">Especialidades</a></li>
            <li><a href="/promociones" className="hover:text-yellow-400 transition-colors">Promociones</a></li>
            <li><a href="/sucursales" className="hover:text-yellow-400 transition-colors">Sucursales</a></li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              ...
              <span>contacto@elbanano.com</span>
            </li>
            <li className="flex items-start">
              <svg className="w-5 h-5 text-yellow-400 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-blue-800 text-center text-blue-300">
        <ul className="flex flex-wrap justify-center gap-4 md:gap-8">
          ...
          <li><a href="/trabaja" className="hover:text-yellow-400 transition-colors">Trabaja con Nosotros</a></li>
        </ul>
